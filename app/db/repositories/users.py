...
class UsersRepository(BaseRepository):
    ...
    async def get_user_by_email(self, *, email: str) -> UserInDB:
        ...
        from pymongo.collection import Collection
        collection: Collection = self.collection  # Assuming self.collection is a pymongo Collection instance
    ...
    async def update_user(  
        ...
        *,
        ...
        updated_at = await self.collection.update_one({"username": user.username}, 
            {"$set": {
        ...
        if password:
            await self.collection.update_one({"username": user.username}, 
                {"$set": {
