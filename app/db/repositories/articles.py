...
class ArticlesRepository(BaseRepository):
    ...
    async def get_articles_for_user_feed(
        ...
        *,
        ...
        # Find articles authored by the users the current user is following
        ...
        *,
        ...
        if article_row:
            return await self._get_article_from_db_record(
                ...
                author_username=article_row['author_id'],  # Assuming you will resolve this later
                requested_user=requested_user,
            )
    ...
    async def add_article_into_favorites(self, *, article: Article, user: User) -> None:
        ...
        # Update the article's favorited_by
